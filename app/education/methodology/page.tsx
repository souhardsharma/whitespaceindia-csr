          ...
          <div className="max-w-4xl mx-auto">
            <FadeIn>
              ...
              <h1 className="font-headline text-5xl md:text-7xl headline-tight text-[#1c1c19] mb-10">
                How we score <span className="italic font-light">education gaps.</span>
              </h1>
            </FadeIn>
            ...
            <FadeIn delay={0.1}>
              <div className="border-t border-[#1c1c19] pt-10 grid grid-cols-1 md:grid-cols-12 gap-10">
                ...
                <div className="md:col-span-8 font-body text-base text-[#1c1c19]/80 leading-relaxed space-y-6">
                  <p>The Education Opportunity Score (EdOS) is a composite index built on the OECD Handbook framework for constructing composite indicators. Three normalised dimensions — School Access (S), Learning Outcomes (L), and Infrastructure Gap (I) — are weighted and combined.</p>
                  <p className="font-label text-sm tracking-wide" style={{ color: accent }}>EdOS = w<sub>S</sub> · S + w<sub>L</sub> · L + w<sub>I</sub> · I</p>
                  <p>Default weights: School Access 35%, Learning 40%, Infrastructure 25%. Users can adjust these in the simulator to match their intervention priorities.</p>
                </div>
              </div>
            </FadeIn>
