...
const IndiaMap = dynamic(() => import("@/components/IndiaMap"), {
  ...
  loading: () => (
    ...
    >
      <div className="w-8 h-8 border-2 border-t-transparent animate-spin" style={{ borderColor: energyConfig.theme.accent, borderTopColor: "transparent" }} />
    </div>
  ),
});
        ...
        >
          ...
          <div className="md:col-span-9">
            ...
            <p className="font-body text-base md:text-lg text-[#1c1c19]/75 leading-relaxed max-w-2xl">
              Three signals from the energy ledger. Each points to a different kind of gap, and a different lever for intervention.
            </p>
          </div>
        </motion.div>
      ...
      <div className="max-w-7xl mx-auto" ref={ref}>
        ...
        >
          <div className="md:col-span-8 p-10 md:p-14 border-b md:border-b-0 md:border-r border-[#1c1c19]">
            ...
            >
              CSR spending patterns, health infrastructure, and education access are also under investigation.
            </motion.p>
            <div className="flex flex-wrap gap-0 border border-[#1c1c19]">
              {["CSR", "Health", "Education"].map((v, i) => (
                <motion.span
                  key={v}
          ...
          >
            ...
            <p className="font-body text-sm text-[#1c1c19]/80 leading-relaxed">
              We are building energy access and transition indices using CEA, Saubhagya, and MNRE data.
            </p>
            <SubscribeForm variant="compact" source="energy" vertical={cfg} />
          </motion.div>
        </motion.div>
      </div>
    </section>
        ...
        >
          <div className="max-w-7xl mx-auto" ref={simulatorRef}>
            ...
            >
              ...
              <div className="md:col-span-9">
                <h2 className="font-headline text-4xl md:text-6xl lg:text-7xl headline-tight text-[#1c1c19] mb-6">
                  Energy <span className="italic font-light">Simulator.</span>
                </h2>
                <p className="font-body text-base md:text-lg text-[#1c1c19]/75 leading-relaxed max-w-2xl">
                  Adjust weights, select an energy domain, and click any state to surface districts with the greatest intervention opportunity.
                </p>
                <p className="mt-4 font-label text-[10px] uppercase tracking-[0.2em] text-[#1c1c19]/60 max-w-2xl">
                  Source · CEA State-wise Generation Reports · Saubhagya Dashboard · MNRE Annual Reports · Census 2011
                </p>
              </div>
            </motion.div>
